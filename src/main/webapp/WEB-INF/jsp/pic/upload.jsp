...
<body ontouchstart>
<!--标题行-->
<h2 style="color: white;background-color: green;text-align: center;background-position: center;">选择图片</h2>
  <div class="page">
    <div class="bd spacing">
        ...
        <div class="weui_btn_area weui">
            ...
            <button class="weui_btn weui_btn weui_btn_warn" id="CallGetWXrefresh" hidden ="true">选择图片</button><br>
            <button class="weui_btn  weui_btn_primary" id="icFuWei" >选择</button>
